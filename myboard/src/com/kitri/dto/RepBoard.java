...
public class RepBoard {
	...
	private String boare_password; //비번
	...
	public RepBoard(int board_seq, int parent_seq, String board_subject, String board_writer, String board_contents,
			Date board_date, String boare_password, int board_viewcount) {
		super();
		...
		this.boare_password = boare_password;
		this.board_viewcount = board_viewcount;
	}
	
	//글쓰기 용도의 생성자
	public RepBoard(String board_subject, String board_writer, String board_contents, String boare_password) {
		super();
		this.board_subject = board_subject;
		this.board_writer = board_writer;
		this.board_contents = board_contents;
	...
	public String getBoare_password() {
		return boare_password;
	}

	public void setBoare_password(String boare_password) {
		this.boare_password = boare_password;
	}
